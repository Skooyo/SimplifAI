...
const NotificationList = () => {
    ...
    return (
        ...
        <div className="w-full flex justify-center items-center mb-32">
            <div className="w-11/12 sm:w-1/2 backdrop-saturate-200 bg-blue-700 rounded-3xl">
                ...
                <div className="w-full flex flex-col justify-center items-center">
                    {notifications && !loading ? (
                        ...
                        <div className="w-1/2 h-10 flex justify-center items-center bg-blue-500 rounded-full m-5 hover:cursor-pointer" onClick={fetchNotifications}>
                ...
                <div>
                    {notifications.length > 0 && (
                        <button className="w-full h-10 bg-blue-400 rounded-b-3xl">Load more</button>
                    )}
                </div>
            </div>
        </div>
