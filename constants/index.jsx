export const features = [
  {
    id: "0",
    caption: "Ease of use",
    title: "Speech to Text Actions",
    text: "Powered by LLM Models, trade and transfer your crypto with ease through simple voice messages.",
    button: {
  ...
  },
  {
    ...
    text: "SimplifAI is powered on a Trusted Execution Environment (TEE), ensuring a secure, trustable, and verifiable AI.",
    button: {
  ...
  {
    id: "2",
    caption: "Portfolio Improvement",
    title: "Real Time Portfolio Management",
    text: "Customize your AI to analyze the market and manage your portfolio in real-time.",
    button: {
      icon: "/images/docs.svg",
      title: "Read the docs",
    },
